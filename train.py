...
# Fully connected layer being added
...
training_set = train_datagen.flow_from_directory("C:/Users/abhin/OneDrive/Documents/PRAVEEN/cv_project/data/train",
                                                 target_size=(64, 64),
                                                 batch_size=5,
                                                 color_mode='grayscale',
                                                 class_mode='categorical')

test_set = test_datagen.flow_from_directory("C:/Users/abhin/OneDrive/Documents/PRAVEEN/cv_project/data/test",
                                            target_size=(64, 64),
                                            batch_size=5,
                                            color_mode='grayscale',
                                            class_mode='categorical') 
